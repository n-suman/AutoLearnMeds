...
# AGENT (randaug-m5-seed42): applying RandAugment M=5 to images at training
...
def _augment(images):
    ...
    # SigLIP normalize -> [-1, 1]; convert to uint8 [0, 255] for RandAugment then back.
...
class PharmaVLM:
    ...
    def forward(self, images, target_ids):
        # AGENT (randaug-m5-seed42): augment in training mode only.
